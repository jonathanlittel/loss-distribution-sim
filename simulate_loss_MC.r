...
rap$balance_0615 <- rap$June2016Balance
rap$June2016Balance <- NULL
rap <- rap[rap$balance_0615>0 & !is.na(rap$balance_0615),]
...
loss_as_pct_of_portfolio_PAR90 <- quantile(losses, c(0.5,0.95, 0.99,
                                          0.999)) / sum(na.omit(rap$balance_0615))
...
# http://stats.stackexchange.com/questions/38856/how-to-generate-correlated-
# random-numbers-given-means-variances-and-degree-of
################
# Now graph it #
################
...
actual_balance <- sort(rap$balance_0615)
